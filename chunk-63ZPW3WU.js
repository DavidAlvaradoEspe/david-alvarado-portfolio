import{a as e}from"./chunk-L3UYHT7M.js";var a="gaussianSplattingVertexDeclaration",r="attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;";e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=r);var s="gaussianSplattingUboDeclaration",i=`#include<sceneUboDeclaration>
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=i);var o="gaussianSplatting",n=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
vCenter 
+ ((meshPos.x*majorAxis
+ meshPos.y*minorAxis)*invViewport*scaleFactor)*scale,pos2d.zw);}`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=n);var t="gaussianSplattingVertexShader",c=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[t]||(e.ShadersStore[t]=c);var b={name:t,shader:c};export{b as a};
