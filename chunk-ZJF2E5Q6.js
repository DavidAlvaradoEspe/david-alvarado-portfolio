import{a as e}from"./chunk-L3UYHT7M.js";var o="pbrFragmentExtraDeclaration",g=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=g);var t="subSurfaceScatteringFunctions",E=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=E);var i="pbrHelperFunctions",u=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=u);var r="pbrDirectLightingSetupFunctions",D=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=D);var a="pbrDirectLightingFalloffFunctions",L=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=L);var n="pbrDirectLightingFunctions",h=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=h);var l="pbrIBLFunctions",A=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=p);var c="pbrBlockImageProcessing",C=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=C);var s="pbrBlockPrePass",S=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=S);var d="pbrDebug",m=`#if DEBUGMODE>0
